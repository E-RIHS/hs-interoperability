...
| | 08-03-2023 | J Padfield | [0.5](https://national-gallery.github.io/dynamic-modelling/?url=https://raw.githubusercontent.com/E-RIHS/hs-interoperability/main/shared-models/Service%20Simple%20Model/Service%20Model%20-%20V0.5.tsv)  |  | Intially an update of model 0.3 to match schema 0.4, but some differences still need to be resolved in relatio to the need for a specific service bibliography and a few other minor differences.
